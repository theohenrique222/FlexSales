...
@section('content')
    ...
    <x-adminlte-profile-widget name="{{ $user[0]['name'] ?? 'Sem identificação' }}" desc="Gestor de vendas" class="elevation-4 bg-primary text-bold"
        ...
        <x-adminlte-profile-col-item class="text-dark" icon="fas fa-lg fa-tasks" title="Total de Vendas" url="/sales" text="{{ $allSales }}" size=6 badge="primary" />
